...
interface CrmDropdownMenuProps {
  ...
  readonly onDepartmentsClick: () => void
}

export default function CrmDropdownMenu({ onContactsClick, onPanelsClick, onDepartmentsClick }: CrmDropdownMenuProps) {
  ...
  return (
    <div className="relative w-full" ref={dropdownRef}>
      ...
      >
        ...
        <span className="hidden sm:inline truncate">CRM</span>
        <svg
      ...
      {isOpen && (
        <div className="absolute top-full left-0 right-0 sm:right-auto sm:left-0 mt-1.5 sm:mt-2 w-full sm:w-56 bg-white dark:bg-gray-800 rounded-lg shadow-lg border border-gray-200 dark:border-gray-700 py-2 z-50 animate-fade-in">
            <button
              onClick={handleContactsClick}
              className="w-full flex items-center gap-3 px-4 py-3 hover:bg-gray-50 dark:hover:bg-gray-700 active:bg-gray-100 dark:active:bg-gray-600 transition-colors text-left touch-manipulation"
            >
            ...
            >
              ...
              <div>
                <div className="font-medium text-gray-900 dark:text-white">Equipes</div>
                <div className="text-xs text-gray-500 dark:text-gray-400">Gerenciar equipes</div>
              </div>
            </button>
          </div>
      )}
